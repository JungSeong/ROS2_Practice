...
class Calculator(Node):
    ...
    def __init__(self):
        ...
        self.arithmetic_argument_subscriber = self.create_subscription(
            ArithmeticArgument, # message type
            'arithmetic_argument', # topic (str)
            self.get_arithmetic_argument, # callback function
            QOS_RKL10V, # qos_profile
            callback_group=self.callback_group) # callback group : callback 함수를 병렬로 실행할 수 있게 해준다
