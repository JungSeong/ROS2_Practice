...
#include "msg_srv_action_interface_example/action/detail/arithmetic_checker__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_srv_action_interface_example::action::ArithmeticChecker_Goal;
    is_plain =
      (
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_Goal)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Goal__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_action_interface_example::action::ArithmeticChecker_Result;
    is_plain =
      (
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_Result)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Result__handle;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: formul
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.formul[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_action_interface_example::action::ArithmeticChecker_Feedback;
    is_plain =
      (
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_Feedback)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Feedback__handle;
}
...
// functions for msg_srv_action_interface_example::action::ArithmeticChecker_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::max_serialized_size_ArithmeticChecker_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Request;
    is_plain =
      (
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_SendGoal_Request)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Response;
    is_plain =
      (
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_SendGoal_Response)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal_Response__handle;
}
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_SendGoal)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Request;
    is_plain =
      (
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_GetResult_Request)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for msg_srv_action_interface_example::action::ArithmeticChecker_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::max_serialized_size_ArithmeticChecker_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Response;
    is_plain =
      (
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_GetResult_Response)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult_Response__handle;
}
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_GetResult)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult__handle;
}
...
// functions for msg_srv_action_interface_example::action::ArithmeticChecker_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::max_serialized_size_ArithmeticChecker_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_action_interface_example::action::ArithmeticChecker_FeedbackMessage;
    is_plain =
      (
...
{
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_FeedbackMessage)() {
  return &msg_srv_action_interface_example::action::typesupport_fastrtps_cpp::_ArithmeticChecker_FeedbackMessage__handle;
}
