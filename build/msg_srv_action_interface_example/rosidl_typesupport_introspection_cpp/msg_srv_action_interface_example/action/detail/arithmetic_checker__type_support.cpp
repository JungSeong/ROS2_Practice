...
{
  new (message_memory) msg_srv_action_interface_example::action::ArithmeticChecker_Goal(_init);
}

void ArithmeticChecker_Goal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_srv_action_interface_example::action::ArithmeticChecker_Goal *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticChecker_Goal_message_member_array[1] = {
  {
    ...
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_Goal, goal_sum),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticChecker_Goal_message_members = {
  ...
  1,  // number of fields
  sizeof(msg_srv_action_interface_example::action::ArithmeticChecker_Goal),
...
{
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_Goal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_Goal)() {
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_Goal_message_type_support_handle;
}
...
void ArithmeticChecker_Result_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) msg_srv_action_interface_example::action::ArithmeticChecker_Result(_init);
}

void ArithmeticChecker_Result_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_srv_action_interface_example::action::ArithmeticChecker_Result *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticChecker_Result_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_Result, all_formula),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_Result, total_sum),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticChecker_Result_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_srv_action_interface_example::action::ArithmeticChecker_Result),
...
{
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_Result_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_Result)() {
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_Result_message_type_support_handle;
}
...
void ArithmeticChecker_Feedback_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) msg_srv_action_interface_example::action::ArithmeticChecker_Feedback(_init);
}

void ArithmeticChecker_Feedback_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_srv_action_interface_example::action::ArithmeticChecker_Feedback *>(message_memory);
  typed_message->~ArithmeticChecker_Feedback();
}

size_t size_function__ArithmeticChecker_Feedback__formul(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return member->size();
}

const void * get_const_function__ArithmeticChecker_Feedback__formul(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return &member[index];
...
void * get_function__ArithmeticChecker_Feedback__formul(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<std::string> *>(untyped_member);
  return &member[index];
...
void fetch_function__ArithmeticChecker_Feedback__formul(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__ArithmeticChecker_Feedback__formul(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__ArithmeticChecker_Feedback__formul(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__ArithmeticChecker_Feedback__formul(untyped_member, index));
  const auto & value = *reinterpret_cast<const std::string *>(untyped_value);
  item = value;
}

void resize_function__ArithmeticChecker_Feedback__formul(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<std::string> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticChecker_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_Feedback, formul),  // bytes offset in struct
    nullptr,  // default value
    size_function__ArithmeticChecker_Feedback__formul,  // size() function pointer
    get_const_function__ArithmeticChecker_Feedback__formul,  // get_const(index) function pointer
    get_function__ArithmeticChecker_Feedback__formul,  // get(index) function pointer
    fetch_function__ArithmeticChecker_Feedback__formul,  // fetch(index, &value) function pointer
    assign_function__ArithmeticChecker_Feedback__formul,  // assign(index, value) function pointer
    resize_function__ArithmeticChecker_Feedback__formul  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticChecker_Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(msg_srv_action_interface_example::action::ArithmeticChecker_Feedback),
...
{
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_Feedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_Feedback)() {
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_Feedback_message_type_support_handle;
}
...
void ArithmeticChecker_SendGoal_Request_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Request(_init);
}

void ArithmeticChecker_SendGoal_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticChecker_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Request, goal_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<msg_srv_action_interface_example::action::ArithmeticChecker_Goal>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Request, goal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticChecker_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Request),
...
{
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_SendGoal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_SendGoal_Request)() {
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_SendGoal_Request_message_type_support_handle;
}
...
void ArithmeticChecker_SendGoal_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Response(_init);
}

void ArithmeticChecker_SendGoal_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticChecker_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Response, accepted),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Response, stamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticChecker_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Response),
...
{
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_SendGoal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_SendGoal_Response)() {
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_SendGoal_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers ArithmeticChecker_SendGoal_service_members = {
  ...
  // see get_service_type_support_handle<msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal>()
...
get_service_type_support_handle<msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal>()
{
  ...
  auto service_type_support =
    &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_SendGoal_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_SendGoal)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<msg_srv_action_interface_example::action::ArithmeticChecker_SendGoal>();
}
...
void ArithmeticChecker_GetResult_Request_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Request(_init);
}

void ArithmeticChecker_GetResult_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticChecker_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Request, goal_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticChecker_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Request),
...
{
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_GetResult_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_GetResult_Request)() {
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_GetResult_Request_message_type_support_handle;
}
...
void ArithmeticChecker_GetResult_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Response(_init);
}

void ArithmeticChecker_GetResult_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticChecker_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Response, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<msg_srv_action_interface_example::action::ArithmeticChecker_Result>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticChecker_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Response),
...
{
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_GetResult_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_GetResult_Response)() {
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_GetResult_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers ArithmeticChecker_GetResult_service_members = {
  ...
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<msg_srv_action_interface_example::action::ArithmeticChecker_GetResult>()
  nullptr,  // request message
  nullptr  // response message
};
...
get_service_type_support_handle<msg_srv_action_interface_example::action::ArithmeticChecker_GetResult>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_GetResult_service_type_support_handle;
  // get a non-const and properly typed version of the data void *
  auto service_members = const_cast<::rosidl_typesupport_introspection_cpp::ServiceMembers *>(
    static_cast<const ::rosidl_typesupport_introspection_cpp::ServiceMembers *>(
      service_type_support->data));
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Request
      >()->data
      );
    // initialize the response_members_ with the static function from the external library
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::msg_srv_action_interface_example::action::ArithmeticChecker_GetResult_Response
      >()->data
      );
  }
  // finally return the properly initialized service_type_support handle
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_GetResult)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<msg_srv_action_interface_example::action::ArithmeticChecker_GetResult>();
}
...
void ArithmeticChecker_FeedbackMessage_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) msg_srv_action_interface_example::action::ArithmeticChecker_FeedbackMessage(_init);
}

void ArithmeticChecker_FeedbackMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_srv_action_interface_example::action::ArithmeticChecker_FeedbackMessage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticChecker_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_FeedbackMessage, goal_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<msg_srv_action_interface_example::action::ArithmeticChecker_Feedback>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::action::ArithmeticChecker_FeedbackMessage, feedback),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticChecker_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_srv_action_interface_example::action::ArithmeticChecker_FeedbackMessage),
...
{
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_FeedbackMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, action, ArithmeticChecker_FeedbackMessage)() {
  return &::msg_srv_action_interface_example::action::rosidl_typesupport_introspection_cpp::ArithmeticChecker_FeedbackMessage_message_type_support_handle;
}
